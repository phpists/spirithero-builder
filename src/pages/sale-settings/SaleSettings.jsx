...
function SaleSettings() {
    ...
    const formSettings = [
        {
            title: 'How do you want your orders shipped?',
        },
        {
            title: 'How should we sort your orders?',
        },
        {
            title: 'Schedule Your Flash Sale End Date',
        },
        {
            title: 'Switch to On Demand Ordering After Flash Sale',
        },
        {
            title: 'Add a Fundraising Progress Bar to Your Store'
        }
    ];
    ...
    return (
            <div className="sale-settings">
                ...
                {formSettings.map((element , index) => (<div key={index}  className="block-form" >
                    <div className="header-form" onClick={() => {
                        if (visibleFormIndex === index) {
                    ...
                    {visibleFormIndex === index && <div>
                        <div className="block-form-buttons">
                            <div className="block-button-form">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M29 28.25V14.75H24.5V11.75H15.5V17.75H11V28.25" stroke="#4E008E" strokeWidth="1.5"
                        ...
                        <div style={{display: 'flex' , justifyContent: 'flex-start', marginLeft: '20px'}}>
                            ...
                            <p>Organize my orders!  Examples:  Sort by grade level, teacher name, coach name, team name, etc)</p>
                        </div>
                    </div>}
                </div>))}
            </div>
