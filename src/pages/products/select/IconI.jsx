function IconI() {
    return (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_4453_18163)">
                <path d="M8 6H8.00667" stroke="#FBB041" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M7.3335 8H8.00016V10.6667H8.66683" stroke="#FBB041" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
